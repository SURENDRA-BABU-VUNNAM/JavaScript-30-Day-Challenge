{/* <body style="background-color: rgb(255, 255, 255); user-select: none;" unselectable="on"> 
  ...
  <script type="text/javascript">
      $("body").attr("unselectable","on").css({"-moz-user-select":"-moz-none", "-moz-user-select":"none", "-o-user-select":"none", "-khtml-user-select":"none", "-webkit-user-select":"none", "-ms-user-select":"none", "user-select":"none"}).bind("selectstart", function(){ return false;}); $("body").on("contextmenu",function(e){return false;});
    </script> 
